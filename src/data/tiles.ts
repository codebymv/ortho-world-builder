...
export const TILE_METADATA: Partial<Record<TileType, TileMetadata>> = {
  ...
  broken_sign: { isOverlay: true, baseTile: 'dirt', scale: 1.08, sortTrim: 0.2 },
...
export const DETAIL_CONFIG: Partial<Record<TileType, { chance: number; types: string[]; scale: number; opacity: number }>> = {
  ...
  hollow_blight: { chance: 0.24, types: ['detail_bone_fragment', 'detail_pebble', 'detail_twig', 'detail_leaf'], scale: 0.26, opacity: 0.48 },
  ...
  ruined_fort_wall: { chance: 0.12, types: ['detail_crack', 'detail_pebble'], scale: 0.2, opacity: 0.42 },
  ruined_fort_wall_mossy: { chance: 0.18, types: ['detail_leaf', 'detail_mushroom_small', 'detail_crack'], scale: 0.24, opacity: 0.48 },
