...
export const regionContentRegistry: RegionContentEntry[] = [
  ...
  },
  {
    ...
    mapIds: ['forest'],
    interiorIds: ['interior_cottage_forest', 'interior_ranger_cabin', 'interior_woodcutter_cottage', 'interior_hunter_cottage', 'interior_surveyors_hollow', 'interior_travelers_inlet', 'interior_hollow_arena'],
  },
  {
    id: 'guilrhym',
    label: 'Guilrhym',
